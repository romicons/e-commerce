...
export const Login = () => {
    ...
    return (
        <VStack paddingBlock={6} w='100%'>
            ...
            <VStack padding={4} gap={2} boxShadow="md" width='80%' justifyContent='center' alignItems='center' borderRadius='lg' bg={inputBgColor}>
                <FormControl gap={1} display='flex' flexDirection='column' isRequired>
                    ...
                    <RadioGroup onChange={setAvatar} value={avatar}>
                            ...
                            {[...Array(8)].map((_, index) => (
                                <GridItem key={index} display="flex" justifyContent="center" alignItems="center">
                                    <AvatarImage 
                                        ...
                                        isSelected={avatar === `avatar${index + 1}`}
                                        onClick={() => setAvatar(`avatar${index + 1}`)}
                                    />
                                </GridItem>
                            ))}
                        </Grid>
                    </RadioGroup>
                    <Button variant='custom' w='60%' gap={1} alignSelf='center'>
                        Registrarte
                    </Button>
                </FormControl>
            </VStack>
